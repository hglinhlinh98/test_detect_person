...
#COCO
specs = [
    SSDSpec(14, 16, SSDBoxSizes(21, 45), [5.5, 6.7, 7.8]),
    SSDSpec(7, 32, SSDBoxSizes(45, 99), [5.5, 6.7, 7.8]),
    SSDSpec(4, 56, SSDBoxSizes(99, 153), [5.5, 6.7, 7.8]),
    SSDSpec(2, 112, SSDBoxSizes(153, 207), [5.5, 6.7, 7.8]),
    SSDSpec(1, 224, SSDBoxSizes(207, 261), [5.5, 6.7, 7.8]),
    SSDSpec(1, 224, SSDBoxSizes(261, 315), [5.5, 6.7, 7.8])
]

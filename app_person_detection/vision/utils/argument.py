...
def _argument():
    ...
    parser.add_argument('--net', default="tiny_mobilenet",
                        help="The network architecture, it can be mb1-ssd, mb1-lite-ssd, mb2-ssd-lite, mb2-ssd-lite_FPN38 or vgg16-ssd.")
    ...
    parser.add_argument('--checkpoint_folder', default='models/train_model/',
